      ...
      >
        <div className="p-8 sm:p-10">
          <div className="mb-8 text-center">
            <h2 className="text-3xl font-display font-bold text-slate-900 tracking-tight">Create an account</h2>
            <p className="mt-2 text-sm text-slate-500">
              Join Aavya to track your orders and checkout faster
            </p>
          </div>
        ...
        <div className="border-t border-slate-100 bg-slate-50 py-6 text-center shadow-inner">
          <p className="text-sm text-slate-600 flex items-center justify-center gap-1.5">
            ...
            <Link to="/login" className="flex items-center gap-1 font-semibold text-primary-600 transition-colors hover:text-primary-700">
